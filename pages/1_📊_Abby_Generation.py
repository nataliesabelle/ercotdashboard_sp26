"""
Abby's ERCOT Generation Dashboard
Analysis of historical generation by fuel type across Texas ERCOT grid.
"""
import sys
...
DATA_PATH = Path(__file__).parent.parent / "abby_dashboard" / "cleaned.csv"
